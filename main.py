...
def predict_img():
    if request.method == "POST":
        if 'file' in request.files:
            ...
            if file_extension == 'jpg':
                process = Popen(["python", "detect.py", '--source', filepath, "--weights","https://tinyurl.com/grenade-best"], shell=True)
                process.wait()
...
if __name__ == "__main__":
    ...
    model = torch.hub.load('.', 'custom','https://tinyurl.com/grenade-best', source='local')
    model.eval()
